...
async function getWeather() {
  ...
  // Now make an API Call with the given requested location
  ...
  //   I got the apiUrl, now I want to fetch the location.
  //   To fetch the location, make use of promise
  ...
  try {
    ...
    if (response.cod == '400') {
      if (response.message == 'Nothing to geocode')
        display.textContent = "Ohh! You forgot to include your city's name!";
    }
    if (response.cod == '404') {
      if (response.message == 'city not found')
        display.textContent = "Location not found, please enter a valid city name!"
    }
    ...
    <p> Temp: ${temp}°C </p>
    <p> Temp Max: ${temp_max}°C <br> Temp Min: ${temp_min}°C </p>
